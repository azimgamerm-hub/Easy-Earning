...
const Deposit = () => {
    ...
    const handleCopyToClipboard = () => {
        if (!activePaymentMethodDetails) return;
    ...
    return (
        <div className="max-w-xl mx-auto bg-gray-100 p-2 sm:p-4 rounded-lg">
            <div className="bg-white rounded-lg shadow-md p-4">
                <h3 className="font-bold text-gray-800 text-center mb-4">Payment Method নির্বাচন করুন</h3>
                ...
                <div className={`p-4 rounded-lg ${selectedColors.bg} border ${selectedColors.border}`}>
                    ...
                    <ol className="space-y-3 text-sm text-gray-700">
                        ...
                        <li className="flex items-start gap-3"><div className={`w-5 h-5 ${selectedColors.bgDark} text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0`}>5</div><span>Transaction ID টি নিচের VERIFY বক্সে বসান</span></li>
                         <li className="flex items-start gap-3"><div className={`w-5 h-5 ${selectedColors.bgDark} text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0`}>6</div><span>সম্পূর্ণ Transaction ID দিলে Verification নিশ্চিত হবে</span></li>
                    </ol>
                </div>
            </div>
